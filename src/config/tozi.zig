...
const logger = std.log.scoped(.tozi);

const GITHUB_API_URL = "https://api.github.com/repos/logotip4ik/tozi/releases/latest";
...
pub const interface: common.ConfInterface = .{
    ...
    .decompressTargetFile = common.DecompressExeName("tozi"),
};
...
fn getTargetFilename() ?[]const u8 {
    ...
    return std.fmt.comptimePrint("tozi-{s}-{s}.tar.gz", .{ os, arch });
}
